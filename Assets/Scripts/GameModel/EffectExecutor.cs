...
public static class EffectExecutor
{
            ...
            case DamageEffect damageEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        gameplayReactor.UpdateAction(new DamageResultAction(actionSource, characterTarget, damageResult, damageStyle));
            ...
            case HealEffect healEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        gameplayReactor.UpdateAction(new HealResultAction(actionSource, characterTarget, healResult));
            ...
            case ShieldEffect shieldEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        gameplayReactor.UpdateAction(new ShieldResultAction(actionSource, characterTarget, shieldResult));
            ...
            case GainEnergyEffect gainEnergyEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        gameplayReactor.UpdateAction(new GainEnergyResultAction(actionSource, playerTarget, gainEnergyResult));
            ...
            case LoseEnegyEffect loseEnegyEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        gameplayReactor.UpdateAction(new LoseEnergyResultAction(actionSource, playerTarget, loseEnergyResult));
            ...
            case AddPlayerBuffEffect addBuffEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        gameplayReactor.UpdateAction(new AddPlayerBuffResultAction(actionSource, playerTarget, addResult));
            ...
            case RemovePlayerBuffEffect removeBuffEffect:
                {
                    ...
                    foreach (var target in targets)
                    {
                        ...
                        {
                            gameplayReactor.UpdateAction(new RemovePlayerBuffResultAction(actionSource, playerTarget, removeResult));
                    ...
                    for (var i = 0; i < cards.Count; i++)
                    {
                        ...
                        card.Owner(gameplayWatcher.GameStatus).MatchSome(cardOwner =>
                        {
                                ...
                                card.Identity, out var discardedCard, out var start, out var destination))
                            {
                                ...
                                gameplayReactor.UpdateAction(new DiscardCardResultAction(actionSource, cardTarget, discardedCard));
            ...
            case ConsumeCardEffect consumeCardEffect:
                {
                    ...
                    for (var i = 0; i < cards.Count; i++)
                    {
                        ...
                        card.Owner(gameplayWatcher.GameStatus).MatchSome(cardOwner =>
                        {
                            ...
                            {
                                var cardTarget = new CardTarget(card);
                                gameplayReactor.UpdateAction(new ConsumeCardResultAction(actionSource, cardTarget, consumedCard));
            ...
            case DisposeCardEffect disposeCardEffect:
                {
                    ...
                    for (var i = 0; i < cards.Count; i++)
                    {
                        ...
                        card.Owner(gameplayWatcher.GameStatus).MatchSome(cardOwner =>
                        {
                            ...
                            {
                                var cardTarget = new CardTarget(card);
                                gameplayReactor.UpdateAction(new DisposeCardResultAction(actionSource, cardTarget, disposedCard));
            ...
            case CreateCardEffect createCardEffect:
                {
                    ...
                    target.MatchSome(targetPlayer =>
                    {
                        foreach (var cardData in createCardEffect.CardDatas)
                        {
                            ...
                            gameplayReactor.UpdateAction(new CreateCardResultAction(actionSource, playerTarget, createResult));
            ...
            case CloneCardEffect cloneCardEffect:
                {
                    ...
                    target.MatchSome(targetPlayer =>
                    {
                        ...
                        foreach (var card in cards)
                        {
                            ...
                            gameplayReactor.UpdateAction(new CloneCardResultAction(actionSource, playerCardTarget, cloneResult));
            ...
            case AddCardBuffEffect addCardBuffEffect:
                {
                    ...
                    for (var i = 0; i < cards.Count; i++)
                    {
                        ...
                        foreach (var addCardBuff in addCardBuffEffect.AddCardBuffDatas)
                        {
                            ...
                            gameplayReactor.UpdateAction(new AddCardBuffResultAction(actionSource, cardTarget, addBuffResult));
        ...
        int drawCount)
    {
        ...
        for (int i = 0; i < drawCount; i++)
        {
                ...
                player.CardManager.Graveyard.Cards.Count > 0)
            {
                ...
                gameplayReactor.UpdateAction(new RecycleDeckResultAction(new PlayerTarget(player)));
        ...
        IPlayerEntity player)
    {
        if (player.CardManager.Deck.PopCard(out ICardEntity newCard))
        {
            ...
            gameplayReactor.UpdateAction(new DrawCardResultAction(source, new PlayerTarget(player), newCard));
