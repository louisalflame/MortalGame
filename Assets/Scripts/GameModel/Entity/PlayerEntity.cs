...
public interface IPlayerEntity
{
    ...
    void UpdateIntent(IGameplayStatusWatcher gameWatcher, ITargetActionIntent intent);
    void UpdateResult(IGameplayStatusWatcher gameWatcher, ITargetActionResult result);
}
